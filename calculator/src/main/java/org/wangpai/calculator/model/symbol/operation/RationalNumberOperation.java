...
public class RationalNumberOperation extends FractionOperation {
    /*---------------加减乘除基本运算---------------*/
        ...
        try {
            ...
            try {
                ...
                result = (RationalNumber) (RationalNumberOperation.class
                        ...
                        .invoke(null, first, new RationalNumber((Fraction) second)));
     ...
     */
    protected static RationalNumber add(RationalNumber first, RationalNumber second)
            throws CalculatorException {
        ...
        Fraction gcd = FractionOperation.findGcd(firstDenominator, secondDenominator);

        Fraction firstPrimeFactor = FractionOperation.modsQuotient(firstDenominator, gcd);
        Fraction secondPrimeFactor = FractionOperation.modsQuotient(secondDenominator, gcd);

        return new RationalNumber(
                FractionOperation.add(
                        FractionOperation.multiply(firstNumerator, secondPrimeFactor),
                        FractionOperation.multiply(secondNumerator, firstPrimeFactor)),
                FractionOperation.multiply(firstDenominator, secondPrimeFactor))
                .reduceFraction();
    }
     ...
     * subtract 的最终的运算函数
     */
    protected static RationalNumber subtract(RationalNumber first, RationalNumber second)
            throws CalculatorException {
     ...
     * multiply 的最终的运算函数
     */
    protected static RationalNumber multiply(RationalNumber first, RationalNumber second)
            throws CalculatorException {
        return new RationalNumber(
                FractionOperation.multiply(first.getNumerator(), second.getNumerator()),
                FractionOperation.multiply(first.getDenominator(), second.getDenominator()))
                .reduceFraction();
    }
     ...
     * multiply 的一个直接运算函数
     */
    protected static RationalNumber multiply(RationalNumber first, Fraction second)
            throws CalculatorException {
        return new RationalNumber(
                FractionOperation.multiply(first.getNumerator(), second),
     ...
     * multiply 的一个直接运算函数
     */
    protected static RationalNumber multiply(RationalNumber first, long second)
            throws CalculatorException {
        return RationalNumberOperation.multiply(first, new Fraction(second));
    }

    /**
     * divide 的最终的运算函数
     */
    protected static RationalNumber divide(RationalNumber first, RationalNumber second)
            throws CalculatorException {
        if (second.isZero()) {
    ...
    public static RationalNumber getOpposite(RationalNumber rationalNumber)
            throws CalculatorException {
        return new RationalNumber(
                FractionOperation.getOpposite(rationalNumber.getNumerator()),
